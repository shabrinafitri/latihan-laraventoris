        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-title">
                    <button type="button" id="buttonModalTambahPeminjaman" class="btn btn-primary col-md-12" data-toggle="modal" data-target="#tambahModalPeminjaman" style="width: 100%;">Tambah Peminjaman</button>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <td>@if($key->status == 'dipinjam')<label style="color: red;">Belum Dikembalikan</label> @else <label style="color: green;">Telah Dikembalikan</label> @endif</td>
