...
<body>
	...
	<table class="tg">
		<thead>
		<tr>
		  	<th class="tg-3wr7 center line">Kode Reparasi</th>
	      	<th class="tg-3wr7 center line">Kategori Barang</th>
	      	<th class="tg-3wr7 center line">Nama Barang</th>
	      	<th class="tg-3wr7 center line">Keterangan Reparasi</th>
	      	<th class="tg-3wr7 center line">Jumlah Reparasi</th>
	      	<th class="tg-3wr7 center line">Status Reparasi</th>
		</tr>
		</thead>
		<tbody>
	<br>
	<tbody>
		...
		<tr>
			<td class="tg-rv4w center line" width="20%" >{{ $key->reparasi_id }}</td>
			...
			<td class="tg-rv4w center line" width="20%" >{{ $key->keterangan_reparasi }}</td>
